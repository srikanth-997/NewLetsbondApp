            ...
            <div class="col-12 col-md-9 col-lg-6 col-xl-5">
              ...
              <div class="card" >
                <div class="card-body p-4">
                  <h5 class="text-uppercase text-center mb-4">Register</h5>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="email" id="email" class="form-control form-control-md" value={user_email} onChange={(e)=>setUserEmail(e.target.value)} />
                      </div>
                    </div><br></br>
