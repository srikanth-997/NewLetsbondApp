...
export default function LoginVerify() {
   ...
   const phoneNumber= JSON.parse(localStorage.getItem('phoneNum')) ;

    const handleSubmit = (e) => {
        e.preventDefault();
        Axios.post("http://10.81.4.184:2023/user/register/loginValidateOtp", {}, 
        {
            params: { otpNumber: user_otp }

        }).then((response) => {
            if (response.data) {
                localStorage.setItem('phoneNum', JSON.stringify(response.data.phoneNum))
    ...
    return (
        <div>
            <section id="loginverfysecId" class="vh-100 bg-image"
            >
                            ...
                            <div class="col-12 col-md-9 col-lg-6 col-xl-5">
                                <div class="card" >
                                    <div class="card-body p-5">
                                        <h4 class="text-uppercase text-center text-dark mb-5">Verify OTP</h4>
